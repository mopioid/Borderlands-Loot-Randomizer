...
for tag, content_title, dlc_path in (
    ...
    (
        ...
        "GD_OrchidPackageDef.ItemSetDef_Orchid",
    ),
    (
        Tag.CampaignOfCarnage,
        "Mr. Torgue's Campaign of Carnage",
        "GD_IrisPackageDef.ItemSetDef_Iris",
    ),
    (
        Tag.HammerlocksHunt,
        "Sir Hammerlock's Big Game Hunt",
        "GD_SagePackageDef.ItemSetDef_Sage",
    ),
    (
        Tag.DragonKeep,
        "Tiny Tina's Assault on Dragon Keep",
        "GD_AsterPackageDef.ItemSetDef_Aster",
    ),
    (
        Tag.FightForSanctuary,
        "Commander Lilith & the Fight for Sanctuary",
        "GD_AnemonePackageDef.ItemSetDef_Anemone",
    ),
    (
        Tag.BloodyHarvest,
        "Headhunter 1: Bloody Harvest",
        "GD_FlaxPackageDef.ItemSetDef_Flax",
    ),
    (
        Tag.WattleGobbler,
        "Headhunter 2: Wattle Gobbler",
        "GD_AlliumPackageDef.ItemSetDef_Allium_TG",
    ),
    (
        Tag.MercenaryDay,
        "Headhunter 3: Mercenary Day",
        "GD_AlliumPackageDef.ItemSetDef_Allium_Xmas",
    ),
    (
        Tag.WeddingDayMassacre,
        "Headhunter 4: Wedding Day Massacre",
        "GD_NasturtiumPackageDef.ItemSetDef_NasturtiumVday",
    ),
    (
        Tag.SonOfCrawmerax,
        "Headhunter 5: Son of Crawmerax",
        "GD_NasturtiumPackageDef.ItemSetDef_NasturtiumEaster",
    ),
    (
        Tag.UVHMPack,
        "Ultimate Vault Hunter Upgrade Pack",
        "GD_GladiolusPackageDef.ItemSetDef_Gladiolus",
    ),
    (
        Tag.DigistructPeak,
        "Ultimate Vault Hunter Upgrade Pack 2",
        "GD_LobeliaPackageDef.CustomItemSetDef_Lobelia",
    ),
):
...
for tag, category, default, caption, description in (
    (
        ...
        True,
        "Base Game",
        f"Include items and locations from Borderlands 2's base game.",
    ),
    (
        Tag.PiratesBooty,
        Category.Content,
        True,
        "Pirate's Booty",
        f"Include items and locations from {Tag.PiratesBooty.content_title}.",
    ),
    (
        Tag.CampaignOfCarnage,
        Category.Content,
        True,
        "Campaign Of Carnage",
        f"Include items and locations from {Tag.CampaignOfCarnage.content_title}.",
    ),
    (
        Tag.HammerlocksHunt,
        Category.Content,
        True,
        "Hammerlock's Hunt",
        f"Include items and locations from {Tag.HammerlocksHunt.content_title}.",
    ),
    (
        Tag.DragonKeep,
        Category.Content,
        True,
        "Dragon Keep",
        f"Include items and locations from {Tag.DragonKeep.content_title}.",
    ),
    (
        Tag.FightForSanctuary,
        Category.Content,
        True,
        "Fight For Sanctuary",
        f"Include items and locations from {Tag.FightForSanctuary.content_title}.",
    ),
    (
        Tag.BloodyHarvest,
        Category.Content,
        True,
        "Bloody Harvest",
        f"Include items and locations from {Tag.BloodyHarvest.content_title}.",
    ),
    (
        Tag.WattleGobbler,
        Category.Content,
        True,
        "Wattle Gobbler",
        f"Include items and locations from {Tag.WattleGobbler.content_title}.",
    ),
    (
        Tag.MercenaryDay,
        Category.Content,
        True,
        "Mercenary Day",
        f"Include items and locations from {Tag.MercenaryDay.content_title}.",
    ),
    (
        Tag.WeddingDayMassacre,
        Category.Content,
        ...
        f"Include items and locations from {Tag.WeddingDayMassacre.content_title}.",
    ),
    (
        Tag.SonOfCrawmerax,
        Category.Content,
        True,
        "Son Of Crawmerax",
        f"Include items and locations from {Tag.SonOfCrawmerax.content_title}.",
    ),
    (
        Tag.UVHMPack,
        Category.Content,
        True,
        "UVHM Pack",
        f"Include items from {Tag.UVHMPack.content_title}.",
    ),
    (
        Tag.DigistructPeak,
        Category.Content,
        True,
        "Digistruct Peak",
        f"Include items and locations from {Tag.DigistructPeak.content_title}.",
    ),
    (
        Tag.ShortMission,
        Category.Missions,
        True,
        "Short Missions",
        "Assign items to short side missions.",
    ),
    (
        Tag.LongMission,
        Category.Missions,
        True,
        "Long Missions",
        "Assign items to longer side missions. Longer mission turn-ins provide bonus loot options.",
    ),
    (
        Tag.VeryLongMission,
        Category.Missions,
        False,
        "Very Long Missions",
        "Assign items to very long side missions (including Headhunter missions). Very long mission turn-ins provide even more bonus loot options.",
    ),
    (
        Tag.VehicleMission,
        Category.Missions,
        True,
        "Vehicle Missions",
        "Assign items to missions primarily involving driving vehicles.",
    ),
    (
        Tag.Slaughter,
        Category.Missions,
        False,
        "Slaughter Missions",
        "Assign items to slaughter missions.",
    ),
    (
        Tag.UniqueEnemy,
        Category.Enemies,
        True,
        "Unique Enemies",
        "Assign items to refarmable enemies.",
    ),
    (
        Tag.SlowEnemy,
        Category.Enemies,
        True,
        "Slow Enemies",
        "Assign items to enemies which take longer than usual each kill. Slower enemies drop loot with greater frequency.",
    ),
    (
        Tag.RareEnemy,
        Category.Enemies,
        True,
        "Rare Enemies",
        "Assign items to enemies that are rare spawns. Rare enemies drop loot with greater frequency.",
    ),
    (
        Tag.VeryRareEnemy,
        Category.Enemies,
        False,
        "Very Rare Enemies",
        "Assign items to enemies that are very rare spawns. Very rare enemies drop loot with much greater frequency.",
    ),
    (
        Tag.MobFarm,
        Category.Enemies,
        False,
        "Mob Farms",
        "Assign items to mobs which have rare drops in the vanilla game. Mob farm enemies drop loot rarely (but not too rarely).",
    ),
    (
        Tag.RaidEnemy,
        Category.Enemies,
        False,
        "Raid Enemies",
        "Assign items to raid bosses. Raid bosses drop multiple loot instances guaranteed.",
    ),
    (
        Tag.MissionEnemy,
        Category.Enemies,
        False,
        "Mission Enemies",
        "Assign items to enemies that are only available while doing (or re-doing) a mission.",
    ),
    (
        Tag.EvolvedEnemy,
        Category.Enemies,
        False,
        "Evolved Enemies",
        "Assign items to enemies that are evolved forms of other enemies.",
    ),
    (
        Tag.DigistructEnemy,
        Category.Enemies,
        False,
        "Digistruct Enemies",
        "Assign items to the versions of unique enemies that are encountered in Digistruct Peak.",
    ),
    (
        Tag.Vendor,
        Category.Other,
        False,
        "Special Vendors",
        "Assign items to unique vendors to be purchasable with Seraph Crystals or Torgue Tokens.",
    ),
    (
        Tag.Miscellaneous,
        Category.Other,
        True,
        "Miscellaneous",
        "Assign items to miscellaneous loot locations (boxes that give unique items, etcetera).",
    ),
    (
        Tag.DuplicateItems,
        Category.Settings,
        False,
        "Duplicate Items",
        "For seeds with more locations than items, random items can have multiple locations.",
    ),
    (
        Tag.EnableHints,
        Category.Settings,
        True,
        "Allow Hints",
        "Whether this seed should generate a spoiler log, and also whether hints should be allowed while playing it.",
    ),
):
