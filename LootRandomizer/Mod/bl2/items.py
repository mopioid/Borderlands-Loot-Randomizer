...
Items = (
    ItemPool("Blue Infiltrator / Beast / Banshee / Engineer / Slab / Roboteer", Hint.ClassMod,
    ...
    ItemPool("Blue Killer / Berserker / Binder / Grenadier / Meat / Zapper", Hint.ClassMod,
    ...
    ItemPool("Blue Ninja / War Dog / Cat / Gunner / Crunch / Jill of All Trades", Hint.ClassMod,
    ...
    ItemPool("Blue Professional / Devastator / Fox / Pointman / Toast / Punk", Hint.ClassMod,
    ...
    ItemPool("Blue Shot / Raider / Matriarch / Rifleman / Torch / Anarchist", Hint.ClassMod,
    ...
    ItemPool("Blue Sniper / Renegade / Nurse / Shock Trooper / Sickle / Technophile", Hint.ClassMod,
    ...
    ItemPool("Blue Spy / Tank / Trickster / Specialist / Wound / Prodigy", Hint.ClassMod,
    ...
    ItemPool("Blue Stalker / Titan / Warder / Tactician / Blister / Catalyst", Hint.ClassMod,
    ...
    ItemPool("Blue Survivor / Hoarder / Witch / Veteran / Reaper / Sweetheart", Hint.ClassMod,
    ...
    ItemPool("Blue Rogue / Monk / Cleric / Ranger / Barbarian / Necromancer", Hint.ClassMod,
