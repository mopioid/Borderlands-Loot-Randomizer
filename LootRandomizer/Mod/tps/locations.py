...
Locations: Sequence[locations.Location] = (
    ...
    Enemy("Pumpkin Scav",
        Pawn("PawnBalance_ScavengerBandit_Jetpack_Pumpkin"),
        Pawn("PawnBalance_ScavengerBandit_Pumpkin"),
        Pawn("PawnBalance_ScavengerPsycho_Pumpkin"),
        Pawn("PawnBalance_ScavMidget_Pumpkin"),
    tags=Tag.Holiday|Tag.MobFarm),
    Other("Bloody Harvest Barrel", PumpkinBarrel(), tags=Tag.Holiday, rarities=(3,)),
    Other("Celebration Barrel",
        Behavior("GD_Explosives.Barrels.ExplodingBarrel_Shift_Celebrate:BehaviorProviderDefinition_0.Behavior_SpawnItems_81"),
    tags=Tag.Holiday, rarities=(33,)),
    Other("Mercenary Day Barrel",
        Behavior("GD_Explosives.Barrels.ExplodingBarrel_Shift_Mercenary:BehaviorProviderDefinition_0.Behavior_SpawnItems_98"),
    tags=Tag.Holiday, rarities=(33,)),
    ...
    Other("Basketball Hoop", BasketballHoop(), mission="Space Slam", rarities=(7,) * 15),
    ...
    Enemy("Cosmo Wishbone", Cosmo(), mission="No Such Thing as a Free Launch"),
    ...
    Enemy("Merry Lost Legion",
        ...
        Pawn("PawnBalance_DahlMarine_MercDay"),
        Pawn("PawnBalance_DahlMedic_MercDay"),
        Pawn("PawnBalance_DahlSergeant_MercDay"),
        Pawn("PawnBalance_BadassDahlMarine_MercDay"),
    tags=Tag.Holiday|Tag.MobFarm),
    ...
    Enemy("One of Us",
        Pawn("PawnBalance_BoilBadass", transform=1),
        Pawn("PawnBalance_BoilGuard", transform=1),
        Pawn("PawnBalance_BoilWorker", transform=1),
    mission="Trouble with Space Hurps"),
    Enemy("Better With Butter",
        Pawn("PawnBalance_BoilBadass", transform=2),
        Pawn("PawnBalance_BoilGuard", transform=2),
        Pawn("PawnBalance_BoilWorker", transform=2),
    mission="Trouble with Space Hurps"),
    Enemy("Slimy Yet Satisfying",
        Pawn("PawnBalance_BoilBadass", transform=3),
        Pawn("PawnBalance_BoilGuard", transform=3),
        Pawn("PawnBalance_BoilWorker", transform=3),
    mission="Trouble with Space Hurps"),
    Enemy("Meat Is Murder",
        Pawn("PawnBalance_BoilBadass", transform=5),
        Pawn("PawnBalance_BoilGuard", transform=5),
        Pawn("PawnBalance_BoilWorker", transform=5),
    mission="Trouble with Space Hurps"),
    Enemy("Vegans Are Weird",
        Pawn("PawnBalance_BoilBadass", transform=6),
        Pawn("PawnBalance_BoilGuard", transform=6),
        Pawn("PawnBalance_BoilWorker", transform=6),
    mission="Trouble with Space Hurps"),
    Enemy("Choice Cut",
        Pawn("PawnBalance_HypRatGuard", transform=1),
        Pawn("PawnBalance_HypRatWorker", transform=1),
    mission="Trouble with Space Hurps"),
    Enemy("Yummy Down On This",
        Pawn("PawnBalance_HypRatGuard", transform=2),
        Pawn("PawnBalance_HypRatWorker", transform=2),
    mission="Trouble with Space Hurps"),
    Enemy("Marinated Morsel",
        Pawn("PawnBalance_HypRatGuard", transform=3),
        Pawn("PawnBalance_HypRatWorker", transform=3),
    mission="Trouble with Space Hurps"),
    Enemy("Free-Range, Farm-Fresh",
        Pawn("PawnBalance_HypRatGuard", transform=5),
        Pawn("PawnBalance_HypRatWorker", transform=5),
    mission="Trouble with Space Hurps"),
    Enemy("Eat At Boil's",
        Pawn("PawnBalance_HypRatGuard", transform=6),
        Pawn("PawnBalance_HypRatWorker", transform=6),
    mission="Trouble with Space Hurps"),
    ...
    Enemy("The Sentinel",
        Behavior("GD_FinalBossCorkBig.IOs.IO_LootSpew:BehaviorProviderDefinition_0.Behavior_SpawnItems_86", offset=(0, 0, 256)),
        Behavior(
    ...
    Mission("Chip's Data Mining Adventure (Kill Cookies)",
        MissionTurnInAlt("GD_Ma_Side_CookieDataMining.M_Ma_Side_CookieDataMining"),
