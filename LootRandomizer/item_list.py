...
from .items import Relic, PurpleRelic, BanditGrenade, Fibber


Items = (
    ItemPool("Infiltrator/Beast/Banshee/Engineer/Slab/Roboteer (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Killer/Berserker/Binder/Grenadier/Meat/Zapper (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Ninja/War Dog/Cat/Gunner/Crunch/Jill of All Trades (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Professional/Devastator/Fox/Pointman/Toast/Punk (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Shot/Raider/Matriarch/Rifleman/Torch/Anarchist (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Sniper/Renegade/Nurse/Shock Trooper/Sickle/Technophile (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Spy/Tank/Trickster/Specialist/Wound/Prodigy (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Stalker/Titan/Warder/Tactician/Blister/Catalyst (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Survivor/Hoarder/Witch/Veteran/Reaper/Sweetheart (Blue)", Hint.BlueClassMod,
    ...
    ItemPool("Infiltrator/Beast/Banshee/Engineer/Slab/Roboteer (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Killer/Berserker/Binder/Grenadier/Meat/Zapper (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Ninja/War Dog/Cat/Gunner/Crunch/Jill of All Trades (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Professional/Devastator/Fox/Pointman/Toast/Punk (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Shot/Raider/Matriarch/Rifleman/Torch/Anarchist (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Sniper/Renegade/Nurse/Shock Trooper/Sickle/Technophile (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Spy/Tank/Trickster/Specialist/Wound/Prodigy (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Stalker/Titan/Warder/Tactician/Blister/Catalyst (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Survivor/Hoarder/Witch/Veteran/Reaper/Sweetheart (Purple)", Hint.PurpleClassMod,
    ...
    ItemPool("Rouge/Monk/Cleric/Ranger/Barbarian/Necromancer (Blue)", Hint.ClassMod,
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Assassin", Character.Assassin),
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Merc", Character.Mercenary),
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Siren", Character.Siren),
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Soldier", Character.Soldier),
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Psycho", Character.Psycho),
        BlueAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Mechromancer", Character.Mechromancer),
    ),
    ItemPool("Rouge/Monk/Cleric/Ranger/Barbarian/Necromancer (Purple)", Hint.ClassMod,
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Assassin", Character.Assassin),
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Merc", Character.Mercenary),
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Siren", Character.Siren),
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Soldier", Character.Soldier),
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Psycho", Character.Psycho),
        PurpleAlignmentClassMod("GD_Aster_ItemGrades.ClassMods.BalDef_ClassMod_Aster_Mechromancer", Character.Mechromancer),
    ),
    ...
    ItemPool("Legendary Killer/Gunzerker/Binder/Engineer/Sickle/Anarchist", Hint.ClassMod,
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Assassin_05_Legendary", 0, Character.Assassin),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Merc_05_Legendary", 0, Character.Mercenary),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Siren_05_Legendary", 0, Character.Siren),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Soldier_05_Legendary", 0, Character.Soldier),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Psycho_05_Legendary", 0, Character.Psycho),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Mechromancer_05_Legendary", 0, Character.Mechromancer),
    ),
    ItemPool("Legendary Ninja/Hoarder/Cat/Pointman/Torch/Catalyst", Hint.ClassMod,
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Assassin_05_Legendary", 1, Character.Assassin),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Merc_05_Legendary", 1, Character.Mercenary),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Siren_05_Legendary", 1, Character.Siren),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Soldier_05_Legendary", 1, Character.Soldier),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Psycho_05_Legendary", 1, Character.Psycho),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Mechromancer_05_Legendary", 1, Character.Mechromancer),
    ),
    ItemPool("Legendary Sniper/Titan/Nurse/Ranger/Reaper/Roboteer", Hint.ClassMod,
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Assassin_05_Legendary", 2, Character.Assassin),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Merc_05_Legendary", 2, Character.Mercenary),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Siren_05_Legendary", 2, Character.Siren),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Soldier_05_Legendary", 2, Character.Soldier),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Psycho_05_Legendary", 2, Character.Psycho),
        Gen2ClassMod("GD_Lobelia_ItemGrades.ClassMods.BalDef_ClassMod_Lobelia_Mechromancer_05_Legendary", 2, Character.Mechromancer),
    ),
    ...
    ItemPool("Allegiance Relic (Bandit)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceA_Rare")),
    ItemPool("Allegiance Relic (Dahl)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceB_Rare")),
    ItemPool("Allegiance Relic (Hyperion)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceC_Rare")),
    ItemPool("Allegiance Relic (Jakobs)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceD_Rare")),
    ItemPool("Allegiance Relic (Maliwan)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceE_Rare")),
    ItemPool("Allegiance Relic (Tediore)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceF_Rare")),
    ItemPool("Allegiance Relic (Torgue)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceG_Rare")),
    ItemPool("Allegiance Relic (Vladof)", Hint.PurpleRelic, PurpleRelic("GD_Artifacts.A_Item.A_AllegianceH_Rare")),
    ...
    ItemPool("Hyperion Pistol", Hint.PurplePistol,
        ...
        # TODO: fix etech barrel inclusion
    ),
    ...
    ItemPool("Fibber (Shotgun)", Hint.UniquePistol, Fibber("GD_Weap_Pistol.A_Weapons_Unique.Pistol_Hyperion_3_Fibber", 0)),
    ItemPool("Fibber (Ricochet)", Hint.UniquePistol, Fibber("GD_Weap_Pistol.A_Weapons_Unique.Pistol_Hyperion_3_Fibber", 1)),
    ItemPool("Fibber (Crit)", Hint.UniquePistol, Fibber("GD_Weap_Pistol.A_Weapons_Unique.Pistol_Hyperion_3_Fibber", 2)),
